...
public class AssignmentDetailsController implements Initializable {
    ...
    private void populateView() {
        ...
        syncDescriptionMode();
        if (editButton != null) {
            editButton.setDisable(!assignment.isOwnedByCurrentUser());
        }
        if (editDescriptionButton != null) {
            editDescriptionButton.setDisable(!assignment.isOwnedByCurrentUser());
        }
        if (saveDescriptionButton != null) {
            saveDescriptionButton.setDisable(!assignment.isOwnedByCurrentUser());
        }
    }
    ...
    private void syncDescriptionMode() {
        boolean canEdit = assignment != null && assignment.isOwnedByCurrentUser();
