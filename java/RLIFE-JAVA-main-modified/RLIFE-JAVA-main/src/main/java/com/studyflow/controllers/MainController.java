...
public class MainController implements Initializable {
    ...
    private void showAssignments() {
        activateAssignmentsView("views/Assignments.fxml");
    }
    ...
    private void showProjects() {
        activateProjectsView("views/Projects.fxml");
    }
    ...
    private void activateProjectsView(String fxmlPath) {
        setActiveButton(btnProjects);
        loadContent(fxmlPath);
    }

    private void activateAssignmentsView(String fxmlPath) {
    ...
    public static void showProjectsPage() {
        if (instance != null) {
            instance.activateProjectsView("views/Projects.fxml");
        }
    }

    public static void showProjectCreatePage() {
        if (instance != null) {
            instance.activateProjectsView("views/ProjectCreate.fxml");
        }
    }

    public static void showProjectEditPage() {
        if (instance != null) {
            instance.activateProjectsView("views/ProjectEdit.fxml");
        }
    }

    public static void showProjectDeletePage() {
        if (instance != null) {
            instance.activateProjectsView("views/ProjectDelete.fxml");
        }
    }

    public static void showProjectDetailsPage() {
        if (instance != null) {
            instance.activateProjectsView("views/ProjectDetails.fxml");
        }
    }

    public static void showAssignmentsPage() {
        if (instance != null) {
            instance.activateAssignmentsView("views/Assignments.fxml");
        }
    }

    public static void showStatisticsPage() {
        if (instance != null) {
            instance.setActiveButton(instance.btnStats);
            instance.loadContent("views/Statistics.fxml");
        }
    }

    public static void showAssignmentCreatePage() {
        if (instance != null) {
            instance.activateAssignmentsView("views/AssignmentCreate.fxml");
        }
    }

    public static void showAssignmentEditPage() {
        if (instance != null) {
            instance.activateAssignmentsView("views/AssignmentEdit.fxml");
        }
    }

    public static void showAssignmentDeletePage() {
        if (instance != null) {
            instance.activateAssignmentsView("views/AssignmentDelete.fxml");
        }
    }
}
